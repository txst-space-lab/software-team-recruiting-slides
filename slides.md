...
<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <img alt="Danielle, Chippy and Nate Gay in front of the TXST sign" class="rounded-lg shadow-lg" src="./images/nate_and_danielle.jpeg">
  </div>
</div>
...
<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <img alt="PROVES - Maia engineering model assembly in TXST Space Lab" class="rounded-lg shadow-lg" src="./images/assembly_closeup.jpeg">
  </div>
</div>
...
<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <img alt="5 flight satellites during integration prep at TXST Space Lab" class="rounded-lg shadow-lg" style="max-height:400px" src="./images/5_flight_satellites_during_integration_prep.jpeg">
  </div>
</div>
...
<div class="grid grid-cols-2 gap-4">
  <div>
    ...
    <br/>
    <img alt="TXST Space Lab with Tim Dodd at the Astro Awards" class="rounded-lg shadow-lg mb-4" src="./images/astro_awards.png">
  </div>
  <div>
    <img alt="TXST Space Lab team at Firefly Aerospace in Cedar Park, TX" class="rounded-lg shadow-lg" src="./images/firefly_tour.jpg">
  </div>
</div>
...
<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <img alt="Testing magnetorquer output while programming the detumbling system" class="rounded-lg shadow-lg" src="./images/testing_magnetorquers.jpeg">
    <!-- <img alt="TXST Space Lab team" class="rounded-lg shadow-lg" src="./images/ice_cream_social.jpeg"> -->
    <!-- <img alt="Velvet Taco visit to TXST Space Lab after Ecosystem Space meetup in Austin TX" class="rounded-lg shadow-lg" src="./images/velvet_taco_after_ecosystem_space.jpeg"> -->
    <!-- <img alt="PROVES team at Space Center Houston" class="rounded-lg shadow-lg" src="./images/space_center_houston.jpeg"> -->
  </div>
</div>
...
<div class="grid grid-cols-2 gap-4">
  ...
  <div>
    <img alt="QR code to application form" class="rounded-lg shadow-lg" src="./images/application_qr_code.png">
  </div>
</div>
